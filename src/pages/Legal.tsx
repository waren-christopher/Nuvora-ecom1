          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-custom-lg">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  <strong className="text-foreground">Educational Services Only:</strong> Nuvora Ecom 
            ...
            <Card className="shadow-custom-lg">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <div>
                  ...
                  <p>
                    Nuvora Ecom provides educational training programs, consultancy services, 
                ...
                <div>
                  ...
                  <p>
                    Nuvora Ecom shall not be liable for any indirect, incidental, special, 
            ...
            <Card className="shadow-custom-lg">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <div>
                  ...
                  <p>
                    Nuvora Ecom is a registered private limited company in India and operates 
